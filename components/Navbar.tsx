        ...
        <div className="flex items-center gap-0.5 ml-auto" ref={mobileMenuRef}>
          ...
          <div className="relative">
            <motion.button
              ...
              style={{
                color: pathname === "/" ? "#34d399" : "rgba(255,255,255,0.28)",
                backgroundColor: pathname === "/" ? "rgba(52,211,153,0.1)" : "transparent",
              }}
          ...
          <div className="relative">
            <motion.button
              ...
              onMouseEnter={() => setHoveredItem("__settings")}
              onMouseLeave={() => setHoveredItem(null)}
              className="flex items-center justify-center w-7 h-7 rounded-lg transition-all duration-200"
              style={{
                color: pathname === "/settings" ? "#94a3b8" : "rgba(255,255,255,0.28)",
                backgroundColor: pathname === "/settings" ? "rgba(148,163,184,0.1)" : "transparent",
              }}
              whileHover={{ backgroundColor: "rgba(148,163,184,0.1)", color: "#94a3b8" }}
              whileTap={{ scale: 0.93 }}
              aria-label="Settings"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <AnimatePresence>
              {hoveredItem === "__settings" && (
                <motion.div
                  className="absolute top-full left-1/2 mt-1.5 px-2 py-0.5 rounded-md text-[9px] font-sans whitespace-nowrap pointer-events-none"
                  style={{ backgroundColor: "rgba(148,163,184,0.1)", color: "#94a3b8", border: "1px solid rgba(148,163,184,0.18)", x: "-50%" }}
                  initial={{ opacity: 0, y: -3, scale: 0.95 }}
                  animate={{ opacity: 1, y: 0, scale: 1 }}
                  exit={{ opacity: 0, y: -3, scale: 0.95 }}
                  transition={{ duration: 0.1 }}
